...
- (void)viewDidLoad {
    ...
    // 请替换为您的账号信息
    _service = [[HttpDnsService alloc] initWithAccountID:000000 // 您的 Account ID
                                               secretKey:@"your_secret_key_here" // 您的 Secret Key
                                            aesSecretKey:@"your_aes_secret_key_here"]; // 您的 AES Secret Key
