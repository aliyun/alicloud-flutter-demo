...
public class HttpdnsPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "initialize":
      ...
      guard let accountId = (accountIdAny as? Int) ?? Int((accountIdAny as? String) ?? "") else {
        NSLog("HttpdnsPlugin: initialize missing accountId")
        result(false)
        return
      }
    ...
    case "setLogEnabled":
      ...
      NSLog("HttpdnsPlugin: log desired=\(enabled)")
      result(nil)
    ...
    case "setHttpsRequestEnabled":
      ...
      NSLog("HttpdnsPlugin: https request desired=\(enabled)")
      result(nil)
    ...
    case "setPersistentCacheIPEnabled":
      ...
      NSLog("HttpdnsPlugin: persistent cache desired=\(enabled) discard=\(discard ?? -1)")
      result(nil)
    ...
    case "setReuseExpiredIPEnabled":
      ...
      NSLog("HttpdnsPlugin: reuse expired ip desired=\(enabled)")
      result(nil)
    ...
    case "setPreResolveAfterNetworkChanged":
      ...
      NSLog("HttpdnsPlugin: preResolveAfterNetworkChanged desired=\(enabled)")
      result(nil)
    ...
    case "build":
      ...
      NSLog("HttpdnsPlugin: build completed accountId=\(accountId)")
      result(true)
